...
import { Loader2, LogOut, BarChart3, Database, Users, Phone, Tv, Zap, Megaphone, Settings2, BadgePercent } from "lucide-react";
...
import AgentApplicationsTab from "./_components/AgentApplicationsTab";
// Design tokens
const T = {
  bg:         "#CEC0BB",
...
export default function AdminDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<"analytics" | "broadcasts" | "plans" | "users" | "airtime" | "cable" | "power" | "agentApplications" | "settings">("analytics");
  ...
  const TABS = [
    ...
    { id: "agentApplications" as const, label: "Agent Applications", icon: BadgePercent },
    ...
    <div style={{
      ...
      <div style={{
        ...
        {activeTab === "plans" && <DataPlansTab />}
            ...
            {activeTab === "agentApplications" && <AgentApplicationsTab />}
